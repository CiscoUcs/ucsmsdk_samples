...
def bios_create(handle,parent_org_dn,name, descr="",
    ...
    Args:
        ...
        vp_resume_on_ac_power_loss: "last-state", "platform-default","reset", "stay-off"
        vp_serial_port_a_enable: "disabled", "enabled", "platform-default"
        vp_baud_rate: "115200", "19200", "platform-default"
        vp_console_redirection: "com-0", "disabled", "enabled", "platform-default"
        ...
        vp_terminal_type: "pc-ansi", "platform-default", "vt-utf8", "vt100", "vt100-plus"


    Returns:
         Bios Profile: Managed Object
    ...
    mo_5 = BiosVfResumeOnACPowerLoss(parent_mo_or_dn=mo,
                                     ...
                                     vp_resume_on_ac_power_loss)
    mo_6 = BiosVfSerialPortAEnable(parent_mo_or_dn=mo, vp_serial_port_a_enable=vp_serial_port_a_enable)
...
def bios_remove(handle,name,parent_org_dn):
    ...
    if mo:
        ...
        raise ValueError("Bios policy '%s' not found.Nothing to remove" % parent_org_dn)

def bios_add_token(handle, name, parent_org_dn, token_name, token_value):
    # TODO
    pass

def bios_serial_port(handle, name, parent_org_dn, vp_serial_port_a_enable="platform-default"):
    ...
    Example:
        bios_serial_port(handle,name="sample_bios",parent_dn="org-root/org/sample",
    ...
    if obj:
        mo = BiosVfSerialPortAEnable(parent_mo_or_dn=obj, vp_serial_port_a_enable=vp_serial_port_a_enable)
...
def bios_console_redirection(handle, name, parent_org_dn,
    ...
    Example:
        bios_console_redirection(handle,name="sample_bios",parent_dn="org-root/org-sample",
                    vp_baud_rate="115200")
    """
    from ucsmsdk.mometa.bios.BiosVfConsoleRedirection import BiosVfConsoleRedirection
    profile_dn = parent_org_dn + "/bios-prof-" + name
...
def bios_conf_quiet_boot(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_quiet_boot(handle,name="sample_bios",parent_dn="org-root/org-sample",
                    vp_quite_boot="enabled")
    """
...
def bios_conf_error_pause(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_error_pause(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_power_loss(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_power_loss(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_front_panel_lockout(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_front_panel_lockout(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_device_name_control(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_device_name_control(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_intel_speed_step(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_enhanced_intel_speed_step_tech : "platform-default","disabled", "enabled"

    Returns:
        None

    Example:
        bios_conf_intel_speed_step(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_hyper_threading(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_hyper_threading(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_core_multi_processing(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_core_multi_processing(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_disable_bit(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_disable_bit(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_virtual_tech(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_intel_virtualization_technology : "platform-default","disabled", "enabled"
...
def bios_conf_processor_prefetch(handle, name, parent_org_dn,
    ...
    Args:
        ...
        vp_adjacent_cache_line_prefetcher: "disabled", "enabled", "platform-default"
    ...
    Example:
        bios_conf_processor_prefetch(handle,name="sample_bios",parent_dn="org-root/org-sample",
                    vp_dcuip_prefetcher="enabled",vp_hardware_prefetcher="enabled")
    """
...
def bios_conf_direct_cache_access(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_direct_cache_access(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_processor_c_state(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_processor_c_state(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_processor_c1_e(handle, name, parent_org_dn,
    ...
    Example:
        bios_conf_processor_c1_e(handle,name="sample_bios",parent_dn="org-root/org-sample",
...
def bios_conf_processor_c3_report(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_processor_c3_report : "acpi-c2", "acpi-c3","platform-default","disabled", "enabled"
...
def bios_conf_cpu_performance(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_cpu_performance : "platform-default","custom", "enterprise", "high-throughput"
...
def bios_conf_pstate_coordination(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_pstate_coordination : "hw-all", "sw-all", "sw-any" "platform-default"
    Returns:
        None
...
def bios_conf_inter_leave(handle, name, parent_org_dn,
    ...
    Args:
        ...
        vp_memory_interleaving : "2-way-node-interleave", "4-way-node-interleave" etc
    Returns:
        None
...
def bios_conf_intel_directed_io(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_intel_vtd_pass_through_dma_support : "disabled", "enabled", "platform-default"
        vp_intel_vtdats_support: "disabled", "enabled", "platform-default"
        vp_intel_vtd_interrupt_remapping: "disabled", "enabled", "platform-default"
        vp_intel_vtd_coherency_support: "disabled", "enabled", "platform-default"
...
def bios_conf_ras_memory(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_select_memory_ras_configuration: "lockstep", "mirroring" "platform-default", etc
    Returns:
        None
...
def bios_conf_usb_boot(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_legacy_usb_support : "auto", "disabled", "enabled", "platform-default"
...
def bios_conf_usb_idle_power(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_usb_idle_power_optimizing : "high-performance", "lower-idle-power" etc
    Returns:
        None
...
def bios_conf_mapped_mem_io(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_memory_mapped_io_above4_gb: "disabled", "enabled", "platform-default"
    Returns:
        None
...
def bios_conf_boot_watchdog_timer_policy(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_os_boot_watchdog_timer_policy: "power-off", "reset", "platform-default"
    Returns:
        None
...
def bios_conf_boot_watchdog_timer_timeout(handle, name, parent_org_dn,
    ...
    Args:
        ...
        parent_org_dn (string): Dn of parent Org.
        name (string): Name of Bios policy.
        vp_os_boot_watchdog_timer_timeout: "10-minutes", "15-minutes", "platform-default",etc
    Returns:
        None
